...
public class DataBaseGeoExplora extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        // Crear tablas
        db.execSQL("CREATE TABLE IF NOT EXISTS " + TableUsuario.Usuarios.NOMBRE_TABLA + " (" +
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS  " + TableContenidos.Contenidos.NOMBRE_TABLA + " (" +
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS " + TableImagenes.Imagenes.NOMBRE_TABLA + " (" +
